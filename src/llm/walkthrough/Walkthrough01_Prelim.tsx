...
這裡展示的模型是 GPT（生成式預訓練轉換器）系列的一部分，可以說是 "基於上下文的標記預測器"。OpenAI 在 2018 年引入了這一家族，其著名成員包括 GPT-2、GPT-3 和 GPT-3.5 Turbo，後者是廣泛使用的 ChatGPT 的基礎。它還可能與 GPT-4 有關，但具體細節仍不得而知。
