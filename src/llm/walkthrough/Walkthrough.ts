    ...
    return {
        ...
        phaseList: [{
            ...
            phases: [
                ...
                { id: Phase.Input_Detail_SelfAttention, title: '自注意力機制(Self Attention)' },
                { id: Phase.Input_Detail_Projection, title: '投射(Projection)' },
                { id: Phase.Input_Detail_Mlp, title: '多層感知器(MLP)' },
                { id: Phase.Input_Detail_Transformer, title: '變換器(Transformer)' },
